...
class Porudzbina(models.Model):
    ...
    naziv_firme = models.CharField(max_length=100, default="", blank=True)
    pib = models.CharField(max_length=20, default="", blank=True)
    maticni_broj_firme = models.CharField(max_length=20, default="", blank=True)
    ulica = models.CharField(max_length=50)
    broj = models.CharField(max_length=10)
    grad = models.CharField(max_length=50)
    postanski_broj = models.CharField(max_length=10)
    telefon = models.CharField(max_length=20)
    datumPorudzbine = models.CharField(max_length=40)
